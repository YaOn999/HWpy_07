...
# фразе несколько слов, то они разделяются дефисами. Фразы отделяются
# друг от друга пробелами. Стихотворение  Винни-Пух
# вбивает в программу с клавиатуры. В ответе напишите “Парам пам-пам”, если с
# ритмом все в порядке и “Пам парам”, если с ритмом все не в порядке
# *Пример:*
# **Ввод:** пара-ра-рам рам-пам-папам па-ра-па-да
#     **Вывод:** Парам пам-пам
def count_vowerls(poem, vowerls):
    str_poem = ' '.join(poem)
    count = sum(x in vowerls for x in str_poem)
    return 'Парам пам-пам' if count % 2 == 0 else 'Пам парам'


poem = ['пара-ра-рам', 'рам-пам-папам', 'па-ра-па-да']
vowerls = 'аеёиоуыэюя'
print(count_vowerls(poem, vowerls))
